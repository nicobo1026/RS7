 ...
 *   <namePop2Y:12>          # ネームポップの位置を下へ１２ドットずらす
 * 
...
Imported.TMNamePop_forName = true;
...
(function() {
  ...
  var parameters = PluginManager.parameters('TMNamePop_forName');
  ...
  Game_Event.prototype.setupPage = function() {
    ...
    if (this._pageIndex >= 0) {
      this.setNamePop2(this.loadTagParam('namePop2'), +this.loadTagParam('namePop2Y'));
    }
  };
    ...
    if (this._namePop2 !== this._character._namePop2) {
      ...
      if (this._namePop2) {
        if (!this._namePop2Sprite) {
          this._namePop2Sprite = new Sprite_TMNamePop_forName();
          this.addChild(this._namePop2Sprite);
          this._namePop2Sprite.y = this.namePop2ShiftY();
        }
  ...
  Sprite_Character.prototype.namePop2ShiftY = function() {
    return -this.patternHeight() + this._character._namePop2Y;
  };
  
  //-----------------------------------------------------------------------------
  // Sprite_TMNamePop_forName
  //

  function Sprite_TMNamePop_forName() {
    this.initialize.apply(this, arguments);
  }

  Sprite_TMNamePop_forName.prototype = Object.create(Sprite.prototype);
  Sprite_TMNamePop_forName.prototype.constructor = Sprite_TMNamePop_forName;

  Sprite_TMNamePop_forName.prototype.initialize = function() {
  ...
  Sprite_TMNamePop_forName.prototype.update = function() {
    Sprite.prototype.update.call(this);
    this.y = this.parent.namePop2ShiftY();
  };

  Sprite_TMNamePop_forName.prototype.refresh = function(text) {
    this.bitmap.clear();
  ...
  Sprite_TMNamePop_forName.prototype.convertEscapeCharacters = function(text) {
  ...
  Sprite_TMNamePop_forName.prototype.textColor = function(n) {
    var px = 96 + (n % 8) * 12 + 6;
